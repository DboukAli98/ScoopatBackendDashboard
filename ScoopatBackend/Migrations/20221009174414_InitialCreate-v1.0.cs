        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isFarmOwner = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FarmOwners", x => x.OwnerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FarmId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FarmCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CultivationInformations",
                columns: table => new
                {
                    CultivationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductArea = table.Column<double>(type: "float", nullable: false),
                    Season = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalHarvestEstimate = table.Column<double>(type: "float", nullable: false),
                    TotalHarvest = table.Column<double>(type: "float", nullable: false),
                    DeliveredVolume = table.Column<double>(type: "float", nullable: false),
                    FarmId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CultivationInformations", x => x.CultivationId);
                    table.ForeignKey(
                        name: "FK_CultivationInformations_Farms_FarmId",
                        column: x => x.FarmId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FarmersFarms_Farmers_FarmerId",
                        column: x => x.FarmerId,
                        principalTable: "Farmers",
                        principalColumn: "FarmerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FarmersFarms_Farms_FarmId",
                        column: x => x.FarmId,
                        principalTable: "Farms",
                        principalColumn: "FarmId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnersFarms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OwnersFarms_FarmOwners_FarmOwnerOwnerId",
                        column: x => x.FarmOwnerOwnerId,
                        principalTable: "FarmOwners",
                        principalColumn: "OwnerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OwnersFarms_Farms_FarmId",
                        column: x => x.FarmId,
                        principalTable: "Farms",
                        principalColumn: "FarmId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CultivationInformations_FarmId",
                table: "CultivationInformations",
                column: "FarmId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FarmersFarms_FarmerId",
                table: "FarmersFarms",
                column: "FarmerId");

            migrationBuilder.CreateIndex(
                name: "IX_FarmersFarms_FarmId",
                table: "FarmersFarms",
                column: "FarmId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnersFarms_FarmId",
                table: "OwnersFarms",
                column: "FarmId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnersFarms_FarmOwnerOwnerId",
                table: "OwnersFarms",
                column: "FarmOwnerOwnerId");
        }
